...
class Mikor:
    ...
    def __init__(self):
        ...
        self.pp = np.array([
            ...
            # 14
            [[20011, 1], [30011, 1], [40009, 1], [50021, 2711], [75011, 34855],
             [100003, 4329]],
            # 15
            [[30011, 1], [40009, 1], [50021, 14360], [75011, 6348], [100003, 11971]],
            # 16
            [[40009, 1], [50021, 1], [75011, 1], [1000003, 106257]],
            # 17
            [[50021, 1], [75011, 1], [1000003, 106245]],
            # 18
            [[75011, 1], [1000003, 106257]],
            # 19
            [[1000003, 106245]],
            # 20
            [[1000003, 106233]]
        ...
        self.qq = np.array([
            ...
            [[5003, 61, 1494, 58], [6007, 79, 2991, 63], [8191, 89, 3147, 77], [10007, 101, 2123, 57],
             [13001, 113, 6426, 1], [20011, 139, 9832, 1], [30011, 173, 10777, 1], [40009, 199, 15380, 1],
             [50021, 223, 5963, 1]],
            # 13
            [[6007, 79, 1330, 58], [8191, 89, 2, 61], [10007, 101, 684, 90], [13001, 113, 463, 1],
             [20011, 139, 9721, 1], [30011, 173, 13148, 1], [40009, 199, 5491, 1], [50021, 223, 22854, 1]],
            # 14
            [[8191, 89, 2, 75]],
            # 15
            [[10007, 101, 1447, 53]],
